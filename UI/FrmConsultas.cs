...
namespace MiProyectoCSharp.UI
{
    public class FrmConsultas : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbConsultas.Items.Add("1. Jugador m�s costoso por confederaci�n");  
            cmbConsultas.Items.Add("2. Partidos en un estadio espec�fico");
            cmbConsultas.Items.Add("3. Equipo m�s costoso por pa�s (MEX, USA, CAN)");
            cmbConsultas.Items.Add("4. Cantidad de jugadores < 21 a�os por equipo");
        ...
        {
            // Peque�a consulta a pulso para llenar el combobox de estadios r�pidamente
            try
            {
