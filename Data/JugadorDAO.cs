...
namespace MiProyectoCSharp.Data
{
    public class JugadorDAO
    {
        public List<Jugador> ObtenerTodos()
        {
            ...
            string sql = "SELECT id_jugador, nombre, fecha_nacimiento, posicion, peso, estatura, valor_mercado, id_equipo FROM Jugador";
        ...
        // Consultas Especificadas en el Proyecto:
        ...
        public DataTable ObtenerCantidadJugadoresMenoresDe21PorEquipo()
        {
            var dt = new DataTable();
            using var connection = DbConnectionHelper.GetConnection();
            // Oracle months_between(sysdate, fecha) / 12 para edad
            string sql = @"
        ...
        // Reporte: Listar los jugadores cuyo peso, estatura y equipo están dentro de lo solicitado por el usuario.
