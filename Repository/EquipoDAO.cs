...
namespace MiProyectoCSharp.Repository
{
    public class EquipoDAO
    {
        public List<Equipo> ObtenerTodos()
        {
            ...
            string sql = "SELECT e.id_equipo, e.nombre, e.pais, e.valor_total_equipo, c.nombre as nombre_confederacion, c.siglas FROM Equipo e LEFT JOIN Confederacion c ON e.id_confederacion = c.id_confederacion";
            ...
            while (reader.Read())
            {
                lista.Add(new Equipo
                {
                    ...
                    {
                        Nombre = reader["nombre_confederacion"].ToString() ?? "",
        ...
        public bool Insertar(Equipo equipo)
        {
            ...
            cmd.Parameters.Add(new OracleParameter("idConf", equipo.Confederacion.IdConfederacion));
        ...
        public DataTable ObtenerEquipoMasCostosoPorPais()
        {
            ...
            string sql = @"
                WITH EquiposEnPais AS (
                    ...
                    JOIN Equipo e ON e.id_equipo = p.id_equipo_loca
                    
                    l OR e.id_equipo = p.id_equipo_visitante
                )
